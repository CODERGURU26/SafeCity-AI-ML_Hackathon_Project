              ...
              {totalPages <= 5 ? (
                ...
                Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <button
                    ...
                    className={`rounded-lg border px-3 py-1.5 text-sm transition-colors ${currentPage === page
                ...
                <>
                  <button
                    ...
                    className={`rounded-lg border px-3 py-1.5 text-sm transition-colors ${currentPage === 1
                        ? "border-primary bg-primary/10 text-primary"
                        : "border-border bg-secondary text-muted-foreground hover:bg-primary/10 hover:text-primary"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`rounded-lg border px-3 py-1.5 text-sm transition-colors ${currentPage === totalPages
                        ? "border-primary bg-primary/10 text-primary"
                        : "border-border bg-secondary text-muted-foreground hover:bg-primary/10 hover:text-primary"
                      }`}
                  >
